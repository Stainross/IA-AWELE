...
public class MaxNodeAwelicopter extends MinMaxNodeAwelicopter
{
     ...
     */
    MaxNodeAwelicopter (Board board, int depth, double alpha, double beta)
    {
     ...
     */
    @Override
    protected MinMaxNodeAwelicopter getNextNode (Board board, int depth, double alpha, double beta)
    {
        return new MinNodeAwelicopter (board, depth, alpha, beta);
    }
