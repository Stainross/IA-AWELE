...
public class MinNodeAwelicopter extends MinMaxNodeAwelicopter
{
     ...
     */
    MinNodeAwelicopter (Board board, int depth, double alpha, double beta)
    {
    ...
    {
        return new MaxNodeAwelicopter (board, depth, alpha, beta);
    }
