...
public class BoardLearn extends Board {
    /**
    ...
    {
        BoardLearn clone = (BoardLearn) this.clone ();
     ...
     * @throws InvalidBotException
     */
    public BoardLearn playMoveSimulationBoard (int player, double [] decision) throws InvalidBotException
    {
        BoardLearn clone = (BoardLearn) this.clone ();
    ...
    public Object clone ()
    {
        BoardLearn clone = new BoardLearn ();
